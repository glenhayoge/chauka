...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      <PageTitle title="Sign in" description="Sign in to your Chauka account." />
      <Navbar />
      <div className="flex-1 flex items-center justify-center px-4 ">
        <div className="w-full max-w-sm">
          ...
          <form onSubmit={handleSubmit} className="space-y-3">
            <div>
              <label htmlFor="login-username" className="block text-sm text-muted-foreground mb-1">Username</label>
              <input
                id="login-username"
                type="text"
                value={username}
