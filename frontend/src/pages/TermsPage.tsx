  ...
  return (
    <div className="min-h-screen bg-white px-4 py-12">
      <div className="max-w-xl mx-auto">
        <Link to="/login" className="text-sm text-gray-500 hover:text-gray-700">&larr; Back</Link>
        <p className="text-sm font-medium text-gray-900 mt-6 mb-1">Terms and conditions</p>
