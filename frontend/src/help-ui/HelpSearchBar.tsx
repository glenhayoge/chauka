    ...
    <div ref={ref} className="relative w-full max-w-md">
      <div className="relative">
        ...
        <input
          ...
          className="w-full pl-9 pr-3 py-1 text-sm bg-muted border border-border rounded-md placeholder:text-muted-foreground focus:outline-none focus:ring-1 focus:ring-primary"
        />
      </div>
